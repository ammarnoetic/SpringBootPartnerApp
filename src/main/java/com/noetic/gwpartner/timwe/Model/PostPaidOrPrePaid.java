...
public class PostPaidOrPrePaid {
    private static final Logger log = LoggerFactory.getLogger(PostPaidOrPrePaid.class);
    ...
    public PostPaidOrPrePaid(String subscriberNumber, String originTransactionID){
        this.subscriberNumber = subscriberNumber;
        this.originTransactionID = originTransactionID;
    }

    public PostPaidOrPrePaid(PoolingHttpClientConnectionManager connectionManager, HttpClientConnection conn,ConnectionKeepAliveStrategy keepAliveStrategy){
    ...
    public boolean isPostPaid() throws IOException, JSONException, ExecutionException, InterruptedException {
        ...
        if (responseList.get(0) == 0) {
            ...
            if (serviceList.contains(70) || offerList.contains(7000)) {
                isPostPaid = true;
            } else {
                isPostPaid = false;
            }
    ...
    protected static Map<String, List<Integer>> xmlConversion(String xml) throws JSONException {
